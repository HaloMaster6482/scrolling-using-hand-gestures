...
print("Starting gesture-based scrolling control.")
print("Make a fist to scroll down.\nShow an open hand to scroll up.")
...
while cap.isOpened:
    ...
    cv2.imshow("Gesture-Based Scrolling Control", cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
